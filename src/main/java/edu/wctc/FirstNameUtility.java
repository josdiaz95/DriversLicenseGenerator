    ...
    public int encodeFirstName(String firstName,String middleInitial) throws MissingNameException {
        ...
        if (firstName.isBlank()){
            ...
            if (middleInitial.isBlank()){
                sumOfValues = firstNameCodeMap.get(firstName) + valueOfMI;
            }
            else {
                sumOfValues = firstNameCodeMap.get(firstName) + middleInitialCodeMap.get(middleInitial);
            }

        } else if (firstInitialCodeMap.containsKey(firstInitial)){
            if (middleInitial.isBlank()){
                sumOfValues = firstInitialCodeMap.get(firstInitial) + valueOfMI;
            }
            else {
                sumOfValues = firstInitialCodeMap.get(firstInitial) + middleInitialCodeMap.get(middleInitial);
            }
        }
        return sumOfValues;
    }
